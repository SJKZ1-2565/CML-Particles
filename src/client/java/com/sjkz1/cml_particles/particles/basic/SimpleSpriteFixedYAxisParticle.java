...
public class SimpleSpriteFixedYAxisParticle extends BaseCustomParticle
{
    protected SimpleSpriteFixedYAxisParticle(ClientWorld level, double xCoord, double yCoord, double zCoord, SpriteProvider spriteSet, double xd, double yd, double zd, float pitch, float yaw)
    {
    ...
    {
        return "Simple_Sprite_FixedYAxis";
    }
    ...
    public static class Factory implements ParticleFactory<RotateParticleEffect>
    {
                                       ...
                                       double dx, double dy, double dz)
        {
            ...
            return new SimpleSpriteFixedYAxisParticle(level, x, y, z, this.sprites, dx, dy, dz, pitch, yaw);
        }
    }
}
