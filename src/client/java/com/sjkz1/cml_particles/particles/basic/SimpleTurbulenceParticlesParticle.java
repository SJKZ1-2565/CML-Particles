...
public class SimpleTurbulenceParticlesParticle extends BaseCustomParticle
{
    protected SimpleTurbulenceParticlesParticle(ClientWorld level, double xCoord, double yCoord, double zCoord, SpriteProvider spriteSet, double xd, double yd, double zd, float pitch, float yaw)
    {
    ...
    {
        return "Simple_Turbulence_Particles";
    }
    ...
    public static class Factory implements ParticleFactory<RotateParticleEffect>
    {
                                       ...
                                       double dx, double dy, double dz)
        {
            ...
            return new SimpleTurbulenceParticlesParticle(level, x, y, z, this.sprites, dx, dy, dz, pitch, yaw);
        }
    }
}
