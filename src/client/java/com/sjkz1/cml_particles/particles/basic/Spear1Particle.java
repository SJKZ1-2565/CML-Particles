...
public class Spear1Particle extends BaseCustomParticle
{
    protected Spear1Particle(ClientWorld level, double xCoord, double yCoord, double zCoord, SpriteProvider spriteSet, double xd, double yd, double zd, float pitch, float yaw)
    {
    ...
    public static class Factory implements ParticleFactory<RotateParticleEffect>
    {
                                       ...
                                       double dx, double dy, double dz)
        {
            ...
            return new Spear1Particle(level, x, y, z, this.sprites, dx, dy, dz, pitch, yaw);
        }
    }
}
