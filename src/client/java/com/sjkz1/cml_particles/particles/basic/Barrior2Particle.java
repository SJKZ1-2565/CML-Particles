...
public class Barrior2Particle extends BaseCustomParticle
{
    protected Barrior2Particle(ClientWorld level, double xCoord, double yCoord, double zCoord, SpriteProvider spriteSet, double xd, double yd, double zd, float pitch, float yaw)
    {
    ...
    public static class Factory implements ParticleFactory<RotateParticleEffect>
    {
                                       ...
                                       double dx, double dy, double dz)
        {
            ...
            return new Barrior2Particle(level, x, y, z, this.sprites, dx, dy, dz, pitch, yaw);
        }
    }
}
