...
public class SmallTexturesSqureParticle extends BaseCustomParticle
{
    protected SmallTexturesSqureParticle(ClientWorld level, double xCoord, double yCoord, double zCoord, SpriteProvider spriteSet, double xd, double yd, double zd, float pitch, float yaw)
    {
    ...
    {
        return "smallTexturesSquareWave_orbital";
    }
    ...
    public static class Factory implements ParticleFactory<RotateParticleEffect>
    {
                                       ...
                                       double dx, double dy, double dz)
        {
            ...
            return new SmallTexturesSqureParticle(level, x, y, z, this.sprites, dx, dy, dz, pitch, yaw);
        }
    }
}
