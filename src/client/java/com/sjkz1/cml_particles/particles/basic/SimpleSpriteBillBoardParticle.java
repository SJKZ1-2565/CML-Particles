...
public class SimpleSpriteBillBoardParticle extends BaseCustomParticle
{
    protected SimpleSpriteBillBoardParticle(ClientWorld level, double xCoord, double yCoord, double zCoord, SpriteProvider spriteSet, double xd, double yd, double zd, float pitch, float yaw)
    {
    ...
    {
        return "Simple_Sprite_BillBoard";
    }
    ...
    public static class Factory implements ParticleFactory<RotateParticleEffect>
    {
                                       ...
                                       double dx, double dy, double dz)
        {
            ...
            return new SimpleSpriteBillBoardParticle(level, x, y, z, this.sprites, dx, dy, dz, pitch, yaw);
        }
    }
}
